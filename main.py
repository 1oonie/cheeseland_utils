...
class Business(app_commands.Group, name="channel"):
    ...
    async def _create_channel(
        ...
        created_channel = await guild.create_text_channel(
            name=name,
            reason=f'Invocation of "/channel create" by {interaction.user}',
    ...
    async def _archive_channel(
        ...
        for archive_category in archive_categories:
            ...
            await channel.edit(
                ...
                reason=f'Invocation of "/channel archive" by {interaction.user}',
            )
